...
png('../figures/r_16C_manhattan_qqplot_nlme.full.png', width = 1440, height = 480)
print(plot_grid(plotlist = list(r_16C.manhattan, r_16C.QQ), label_size = 36, ncol = 2, rel_widths = c(3,1), align = 'hv'))
dev.off()
...
png('../figures/manhattan_qqplot_M0_r_6C_r_response_nlme.full.png', width = 1440, height = 960)
print(plot_grid(plotlist = list(plt.lst$M0$manhattan, plt.lst$M0$qq,
                ...
                label_size = 36, ncol = 2, rel_widths = c(3,1), align = 'hv'))
dev.off()
```
